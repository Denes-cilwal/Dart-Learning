...
class Student {
  String name = "david"; // Instance Variable with default Getter and Setter

  double _percent = 80; // Private Instance Variable for its own library
  ...
  // Instance variable with Custom Getter : must have return type
